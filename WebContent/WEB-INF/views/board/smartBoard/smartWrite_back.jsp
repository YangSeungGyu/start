...
<script>
	...
	function fileAdd(){
		...
		if(num>=limitFileCount){
			...
			li.innerHTML='첨부파일 #'+countnum+' <input type="file" size="40" name="files" id="file'+countnum+'" />';
...
<input type="hidden" name="testList[0].test" value="1">
<input type="hidden" name="testList[1].test" value="2">
			...
			<div>
				...
				<div>
					<ul id="upload_list"><!--id="upload_list"  -->
						<li >첨부파일 #1 <input name="files" id="file1" type="file" size="40" />
