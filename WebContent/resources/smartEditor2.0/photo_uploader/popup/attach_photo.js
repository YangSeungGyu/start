    ...
    function html5Upload() {	
    	var tempFile,
    		sUploadURL;
//사진업로드 수정1    	
    	sUploadURL= '/board/smartBoard/smartImgHtml5Action.do'; 	//upload URL
...
//사진업로드 수정2 			 		
 			sUrl  : '/board/smartBoard/smartImgAction.do',	//샘플 URL입니다.
//사진업로드 수정3 			
 	        sCallback : '/resources/smartEditor2.0/photo_uploader/popup/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
